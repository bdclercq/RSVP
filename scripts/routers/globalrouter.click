...
elementclass GlobalRouter {
	...
	arpq :: ARPQuerier($address_info) -> output;
	...
	ipgw[1]	-> ICMPError($address_info, parameterproblem) -> rt;
	ttl[1]	-> ICMPError($address_info, timeexceeded) -> rt;
	frag[1]	-> ICMPError($address_info, unreachable, needfrag) -> rt;
